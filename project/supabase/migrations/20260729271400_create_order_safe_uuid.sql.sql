/*
# create_order — safe UUID parsing + SQL exception → JSON error (fix HTTP 400)
*/

CREATE OR REPLACE FUNCTION public.safe_text_uuid(p_text text)
RETURNS uuid
LANGUAGE plpgsql
IMMUTABLE
...
GRANT EXECUTE ON FUNCTION public.safe_text_uuid(text) TO authenticated;
